...
program diffusion
    ...
    ! Initialisation du parallèlisme
    ...
    ! Création de la topology cartésienne MPI pour la décomposition de domaine
    ...
    ! Initilisation des paramètres physiques et du premier domaine
    call timers_mark(1)
