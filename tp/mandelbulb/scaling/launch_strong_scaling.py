...
#
# This script is used to launch a strong scaling study 
# of the Mandelbulb
# 
...
for config in ranks_per_dir:
    ...
    script += "mpirun -np {} python3 ../../mandelbulb.py --domain_size 128 128 128 --ranks_per_dir {} {} {} \n".format(cores, config[0], config[1], config[2])
