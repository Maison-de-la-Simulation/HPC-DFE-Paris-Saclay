...
#
# Script d'aide au trace du temps pour les etudes de scalabilite forte 
# pour le programme OpenMP
#
# ______________________________________________________________________________
...
# Calcul de l'efficacite pour une scalabilite fortre
...
# ______________________________________________________________________________
# Figure du temps de simulation

fig = figure(figsize=(12, 6))
gs = GridSpec(2, 2)
ax = subplot(gs[:,:])

ax.plot(processus,simulation_times,lw=2,label="Temps de simulation")
#ax.plot(processus,mpi_times,lw=2,label="Temps MPI")
