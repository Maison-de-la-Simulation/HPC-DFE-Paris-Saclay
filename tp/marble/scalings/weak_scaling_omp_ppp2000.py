...
# Nombre de processus
times["cores"]       = np.array([1])
# Temps dans la boucle en temps
times["loop"] = np.array([9.259840])
# Temps pour les collisions
times["collision"] = np.array([9.101788])
# Temps dans le pousseur
times["pusher"] = np.array([0.017323])
# Temps dans les echanges de particules
times["exchange"] = np.array([0.077495])
# Temps dans les communications globales
times["global"] = np.array([0.002301])
