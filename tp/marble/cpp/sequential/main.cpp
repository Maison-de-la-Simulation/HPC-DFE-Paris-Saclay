...
int main( int argc, char *argv[] )
{
    ...
    particles.initialization(domain_properties, time_properties, particle_properties);
    //particles.initialization_2(domain_properties, time_properties, particle_properties);
    ...
    for (time_properties.iteration = 1 ; time_properties.iteration <= time_properties.final_iteration; time_properties.iteration++) {
        ...
        particles.push(time_properties.step, domain_properties);
        ...
        collision_counter = particles.multipleCollisions(time_properties, particle_properties);
        ...
        particles.walls(time_properties.step, walls);
