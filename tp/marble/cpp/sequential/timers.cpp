...
void Timers::print() {
    ...
    std::cout << " - " << std::fixed << std::setprecision(6) << std::setw(10) << accumulated_times[0] << " s";
    std::cout << std::endl;
              
    std::cout << " " << std::setw(20) << names[1] ;
    std::cout << " - " << std::fixed << std::setprecision(6) << std::setw(10) << accumulated_times[1] << " s";
    std::cout << std::endl;
    ...
    for (unsigned int i = 2 ; i < names.size() ; i++) {
        ...
        std::cout << " - " << std::fixed << std::setprecision(6) << std::setw(10) << accumulated_times[i] << " s";
