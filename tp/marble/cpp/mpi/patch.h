...
class Patch
{
    ...
    void computeExchangeBuffersPerDirection(struct Parameters params, int direction);
    ...
    void receivedParticlesFromNeighborsSendrecv(std::vector<Patch> & patches, struct Parameters params);
    void receivedParticlesFromNeighborsIsend(std::vector<Patch> & patches, struct Parameters params);
    void receivedParticlesFromNeighborsIsendPack(std::vector<Patch> & patches, struct Parameters params);
    void receivedParticlesPerDirectionSendrecv(std::vector<Patch> & patches, struct Parameters params, int direction);
    void receivedParticlesPerDirectionIsendPack(std::vector<Patch> & patches, struct Parameters params, int direction);
    
    void exchangeParticlesDiagonalTrick(std::vector<Patch> & patches, struct Parameters params);
    void exchangeParticlesDiagonalTrickIsendPack(std::vector<Patch> & patches, struct Parameters params);
