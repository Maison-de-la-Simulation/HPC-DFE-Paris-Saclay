...
int main( int argc, char *argv[] )
{
    ...
    MPI_Irecv(&array[0][0], 1, column, recv_rank, MPI_ANY_TAG, MPI_COMM_WORLD, &request[0]);
    MPI_Isend(&array[0][nx-1], 1, column, send_rank, MPI_ANY_TAG, MPI_COMM_WORLD, &request[1]);
